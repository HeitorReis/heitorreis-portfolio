...
export const metadata: Metadata = {
  ...
  title: {
    default: "Heitor | Hybrid Engineer",
    template: "%s | Heitor",
  },
  description:
    "Portfolio of Heitor, a hybrid engineer and Computer Engineering student working across AI, systems, research, and healthtech.",
